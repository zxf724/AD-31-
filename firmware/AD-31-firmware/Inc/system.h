...
#define KEY_READ(x)             IO_READ(KEY_##x)
...
#define LED_ALL_ON()            do{LED_ON(ERR);LED_ON(NET);}while(0)
#define LED_ALL_OFF()           do{LED_OFF(ERR);LED_OFF(NET);}while(0)
