...
/* Private macros ------------------------------------------------------------*/
#define WIFI_PWR_ON()                   IO_H(WIFI_EN)
#define WIFI_PWR_OFF()                  IO_L(WIFI_EN)

#define WIFI_RST_ON()                   IO_L(WIFI_RST)
#define WIFI_RST_OFF()                  IO_H(WIFI_RST)
