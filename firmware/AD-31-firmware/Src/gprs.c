...
/* Private macros ------------------------------------------------------------*/
#define M2M_PWR_ON()                   IO_H(GSM_EN)
#define M2M_PWR_OFF()                  IO_H(GSM_EN)

#define M2M_KEY_ON()                   IO_L(GSM_KEY)
#define M2M_KEY_OFF()                  IO_H(GSM_KEY)

#define M2M_LED_ON()                   IO_H(LED_GSM)
#define M2M_LED_OFF()                  IO_L(LED_GSM)
